            ...
            <form action="<?= $_SESSION["GLOBAL_URL"] ?>admin.edit" method="post">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-general"
                    ...
                    <div class="tab-pane fade show active" id="nav-general" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="project_id" value="<?= $pageVar["id"] ?>"
                                       readonly hidden>
                        ...
                        <div class="row pt-15 form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_title"
                                       value="<?= $pageVar["title"] ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="row pt-15 form-group">
                            <label for="id" class="col-sm-2 col-form-label">Textcolor</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_color"
                                       value="<?= $pageVar["text_color"] ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_backgroundColor"
                                       value="<?= $pageVar["background_color"] ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_BackgroundImg"
                                       value="<?= $pageVar["background_img"] ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_positionX"
                                       value="<?= $pageVar["positionX"] ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_positionY"
                                       value="<?= $pageVar["positionY"] ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_is_banner"
                                       value="<?= $pageVar["is_banner"] ?>" autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_content_url"
                                       value="<?= $pageVar["content"]["url"] ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="project_content_title"
                                       value="<?= $pageVar["content"]["title"] ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" rows="5" class="form-control"
                                          name="project_content_description"><?= trim($pageVar["content"]["description"]) ?></textarea>
                            </div>
                        </div>
                    </div>
