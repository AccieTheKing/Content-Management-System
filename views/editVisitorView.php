    ...
    <div class="row pt-15">
        <div class="col-6 offset-md-2 col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="project_id" value="<?= $pageVar["id"] ?>" disabled>
            </div>
        </div>
        <div class="col-6 col-md-4">
            <div class="form-group">
                <label for="id">Title</label>
                <input type="text" class="form-control" name="project_title" value="<?= $pageVar["title"] ?>"
    ...
    <div class="row pt-15">
        <div class="col-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="project_color" value="<?= $pageVar["text_color"] ?>"
                       autocomplete="off" disabled>
            </div>
            <div class="form-group">
                <label for="id">Background color</label>
                <input type="text" class="form-control" name="project_backgroundColor"
                       value="<?= $pageVar["background_color"] ?>" autocomplete="off" disabled>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="project_BackgroundImg"
                       value="<?= $pageVar["background_img"] ?>" autocomplete="off" disabled>
            </div>
            <div class="form-group">
                <label for="id">PositionX</label>
                <input type="text" class="form-control" name="project_positionX"
                       value="<?= $pageVar["positionX"] ?>" autocomplete="off" disabled>
            </div>
        </div>
    </div>
    ...
    <div class="row pt-15">
        <div class="col-12">
            <div class="form-group">
                <div class="text-center">
                    <h3>Detail page</h3>
                    <p class="lead">For the page after clicking on a project</p>
                </div>
